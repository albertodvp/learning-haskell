...
day07Tests =
    ...
    , "runCommand" ~: "list (non emptry)" ~: runCommand (List [(Nothing, "subdirname"), (Just 42, "filename")]) (FSState (FSNode "" 0 (Just [FSNode "dirname" 0 $ Just []])) ["dirname"]) ~?= FSState (FSNode "" 42 (Just [FSNode "dirname" 42 $ Just [FSNode "filename" 42 Nothing, FSNode "subdirname" 0 (Just [])]])) ["dirname"]
    ]
